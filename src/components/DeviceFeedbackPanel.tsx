...
export function DeviceFeedbackPanel({ feedbackMessages, collapsed, onToggleCollapse }: DeviceFeedbackPanelProps) {
  ...
  console.log('DeviceFeedbackPanel render - collapsed:', collapsed, 'expandedMessages:', expandedMessages.size)
            ...
            {feedbackMessages.length === 0 ? (
              ...
              feedbackMessages.slice(0, 10).map((message, index) => (
                <div
                  ...
                  className={cn(
                    "p-1 rounded border-l-2 bg-card/60 hover:bg-card transition-all duration-300 transform hover:scale-105 animate-fade-in",
              ...
              feedbackMessages.map((message, index) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "p-2 rounded border border-l-2 bg-card/80 backdrop-blur-sm transition-all duration-500 ease-out hover:bg-card hover:border-l-4 hover:scale-[1.02] hover:shadow-md transform animate-fade-in",
                      getFeedbackBorderColor(message.type),
